...
class UNet(BasicModel):
    def __init__(self, config):
        ...
        conv2 = Conv2D(16, (3, 3), activation='relu',
        ...
        deconv1 = Conv2DTranspose(
            64, (2, 2), strides=(2, 2), padding='same')(conv5)
        ...
        deconv2 = Conv2DTranspose(
            32, (2, 2), strides=(2, 2), padding='same')(conv6)
        ...
        deconv3 = Conv2DTranspose(
            16, (2, 2), strides=(2, 2), padding='same')(conv7)
        deconv3 = concatenate([deconv3, conv2])
        conv8 = Conv2D(16, (3, 3), activation='relu',
        ...
        deconv4 = Conv2DTranspose(
            8, (2, 2), strides=(2, 2), padding='same')(conv8)
        deconv4 = concatenate([deconv4, conv1])
        conv9 = Conv2D(8, (3, 3), activation='relu',
